...
if(!(isset($_POST['dealID']))){
    $stmts = $pdo->query('SELECT d.validity,d.deal_id,d.deal_name, d.deal_logo, d.promo_code, d.tagLine, d.reward, d.reward_unit, d.description,r.deal_status FROM deal d inner join deal_review r on d.deal_id=r.deal_id where r.deal_status="approved"');
