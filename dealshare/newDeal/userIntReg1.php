...
<form id="registrationForm" action="userIntReg1.php" method="POST" enctype="multipart/form-data">
...
<!--Company information tab-->
  <div class="row tab" id="step-1">
        ...
        <div class="col-md-12">
        	...
        	<h3 style="text-align: center;" id="registrationHead">Tell us about your company !</h3>

      		<div class="form-group">
            <label for="companyName">Company name</label>
            <input id="companyName" name="companyName" type="text" class="form-control" oninput="this.className = 'form-control'">
          	</div>

          	<div class="form-group">
            <label for="companyAddress">Company address</label>
            <input id="companyAddress" name="companyAddress" type="text" class="form-control" oninput="this.className = 'form-control'">
          	</div>

          	<div class="form-group">
            <label for="companyPostcode">Company postcode</label>
            <input id="companyPostcode" name="companyPostcode" type="text" class="form-control" oninput="this.className = 'form-control'">
          	</div>
...
<!--Deal information tab-->
  <div class="row tab" id="step-2">
        ...
        <div class="col-md-12">
        	...
        	<h3 style="text-align: center;" id="registrationHead">Tell us about the deal !</h3>

          	<div class="form-group">
            <label for="dealName">Deal name</label>
            <input id="dealName" type="text" name="dealName" class="form-control" oninput="this.className = 'form-control'">
          	</div>

          	<div class="form-group">
            <label for="dealDescription">Deal description</label>
            <input id="dealDescription" type="text" name="dealDescription" class="form-control" oninput="this.className = 'form-control'">
          	</div>

          	<div class="form-group">
            <label for="tagLine">Catchy tag line</label>
            <input id="tagLine" type="text" name="tagLine" class="form-control" oninput="this.className = 'form-control'">
          	</div>

           	<div class="form-group">
            <label for="landingPage">Landing page link</label>
            <input id="landingPage" type="text" name="landingPage" class="form-control" oninput="this.className = 'form-control'">
          	</div>
...
<!--Reward information tab-->
    <div class="row tab" id="step-3">
        ...
        <div class="col-md-12">
           ...
           <h3 style="text-align: center;" id="registrationHead">Tell us about the REWARDS !</h3>
...
<!--Previous and next buttons-->
        ...
        <button class="btn btn-indigo btn-rounded nextBtn float-left" type="button" id="prevBtn" onclick="nextPrev(-1)">Previous</button>
        <button class="btn btn-indigo btn-rounded nextBtn float-right" type="button" id="nextBtn" onclick="nextPrev(1)">Next</button>
        <input type="submit" class="btn btn-indigo btn-rounded nextBtn float-right" name="submit" id="checkBtn" value="Review">
    </div>
